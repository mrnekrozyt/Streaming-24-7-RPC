...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence(client)
    ...
    .setAssetsLargeImage("https://i.imgur.com/CPNfciO.gif") //You can put links in tenor or discord and etc.
    .setAssetsLargeText("I have fallen for you") //Text when you hover the Large image
    .setAssetsSmallImage("https://i.imgur.com/Fu8mZbZ.jpeg") //You can put links in tenor or discord and etc.
